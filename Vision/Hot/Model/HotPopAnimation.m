...
@implementation HotPopAnimation
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext {
    ...
    HotViewController *toVC = (HotViewController *)[transitionContext     viewControllerForKey:UITransitionContextToViewControllerKey];
    ...
    //获取toVC中图片的位置
    HotContentCollectionViewCell *collectionCell = (HotContentCollectionViewCell *)[toVC.contentCollectionView cellForItemAtIndexPath:[[toVC.contentCollectionView indexPathsForVisibleItems] lastObject]];
    HotContentTableViewCell *cell = (HotContentTableViewCell *)[collectionCell.hotContentTableView cellForRowAtIndexPath:toVC.indexPath];
