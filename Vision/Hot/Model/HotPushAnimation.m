...
@implementation HotPushAnimation
...
- (void)animateTransition:(id <UIViewControllerContextTransitioning>)transitionContext {
    HotViewController *fromVC = (HotViewController *)[transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
    ...
    HotContentCollectionViewCell *collectionCell = (HotContentCollectionViewCell *)[fromVC.contentCollectionView cellForItemAtIndexPath:[[fromVC.contentCollectionView indexPathsForVisibleItems] firstObject]];
    HotContentTableViewCell *cell = (HotContentTableViewCell *)[collectionCell.hotContentTableView cellForRowAtIndexPath:[collectionCell.hotContentTableView indexPathForSelectedRow]];
    fromVC.indexPath = [collectionCell.hotContentTableView indexPathForSelectedRow];
